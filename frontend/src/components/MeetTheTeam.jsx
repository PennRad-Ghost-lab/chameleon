      ...
      <div style={{ width: "95%", marginTop: "15px" }}>
        <div className="all-cards">
          <div className="team-cards">
            ...
            <TeamMember picture={dania} name="Dania Daye" institution="University of Pennsylvania" />
            <TeamMember picture={tessa} name="Tessa Cook" institution="University of Pennsylvania" />
          </div>

          <div className="team-cards">
            <TeamMember picture={rithvik} name="Rithvik Sukumaran" institution="Drexel University" />
